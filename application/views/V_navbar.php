    ...
    <div class="collapse navbar-collapse" id="navbarColor02" >
        <ul class="navbar-nav mr-auto float kiri">
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo base_url('C_dashboard_guru') ?>">Home<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('C_proyek_guru') ?>">Proyek</a>
            </li>
            <li class="nav-item">
